...
/**
 * Class description: This java class MenuWindow.java will...
 * 2019-12-19
 * 
 * @author melmensh (SAIT ID:123456)
 *
 */
import javax.swing.*;
import java.awt.*;
...
public class MenuWindow extends JFrame
{
	...
	/**
	 * The buildFileMenu method builds the File menu and returns a reference to its
	 * JMenu object.
	 */
	...
	/**
	 * The buildTextMenu method builds the Text menu and returns a reference to its
	 * JMenu object.
	 */
//
...
//	}
	...
	/**
	 * Private inner class that handles the event that is generated when the user
	 * selects Visible from the Text menu.
	 */
